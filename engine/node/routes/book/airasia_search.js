...
var steps = [
  function() {
	  //Load Login Page
	  page.open("http://www.airasia.com/id/id/login/travel-agent.page",function(){
  ...
  function(){
	  ...
	  page.evaluate(function(args){
		  ...
		  window.$("#ControlGroupLoginAgentView_AgentLoginView_PasswordFieldPassword").val(pass);
		  page.render('example1.png');
		  window.$("#ControlGroupLoginAgentView_AgentLoginView_LinkButtonLogIn").click();
		  __doPostBack('ControlGroupLoginAgentView$AgentLoginView$LinkButtonLogIn','');
		  //page.frameContent;
		  console.log($("#ControlGroupLoginAgentView_AgentLoginView_TextBoxUserID").val());
	  },args);
  },
  function(){
	  page.evaluate(function() {
		  //$("#ControlGroupLoginAgentView_AgentLoginView_LinkButtonLogIn").click();
	      //__doPostBack('ControlGroupLoginAgentView$AgentLoginView$LinkButtonLogIn','');
