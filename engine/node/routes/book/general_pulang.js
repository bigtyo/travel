...
ur = "http://flight.sinar-soft.com/search/?dari=Balikpapan-BPN&ke=Surabaya-SUB&maskapai=ALL&tgl=2014-12-12&dewasa=1&child=1&infant=1";
...
page.open(url, function() {
    ...
    console.log('Status: ' + url);
        ...
        //res.url = url;
        //print data ke file
        var path = 'output_pulang'+searchid+'.json';
        var content = res;
