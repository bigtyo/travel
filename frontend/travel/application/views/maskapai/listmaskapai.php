<form action="../maskapai/simpanmaskapai" method="POST" enctype="multipart/form-data">
<div id="modalAktivitas" class="modal hide fade" tabindex="-1" role="dialog"   aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-header">
				...
				<h3 id="myModalLabel" >Detail Maskapai</h3>
			</div>
                                 ...
                                 <div class="row-fluid">
                                         ...
                                         <table class="table table-bordered table-force-topborder table-condensed table-colored-header">
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr id="tr_<?php echo $agent->idmastermaskapai; ?>">
                                                     ...
                                                     <td><a href="#modalAktivitas" data-toggle="modal" onclick="edit(<?php echo $agent->idmastermaskapai ?>);">edit</a></td>
                                                 </tr>
                                                 <?php } ?>
                                             </tbody>
                                         </table>
...
<script type="text/javascript">
    function addnew(){
        $.get('<?php echo base_url(); ?>index.php/maskapai/addmasterkapai',null,function(res){
            $("#modalContent").html(res);
        });
    }
    
    function edit(idagent){
        $.get('<?php echo base_url(); ?>index.php/maskapai/addmasterkapai',{ id : idagent },function(res){
            $("#modalContent").html(res);
        });
    }
