...
function randomFeed(){
	var $el = $("#randomFeed");
	var random = new Array('<span class="label"><i class="icon-plus"></i></span>Entry Listing baru : <a href="#">Apartmen Eastcoast Residence Tipe Studio</a>','<span class="label label-success"><i class="icon-user"></i></span> Pengunjung telah mendaftarkan Email : <a href="mailto:gunawan@gmail.com">gunawan@gmail.com</a>','<span class="label label-info"><i class="icon-shopping-cart"></i></span><a href="#listing">Ruko 2 lantai San Diego</a> Terjual melalui <a href="#budi">Agen Budi</a>','<span class="label label-warning"><i class="icon-comment"></i></span> <a href="#">John Doe</a> commented on <a href="#">News #123</a>'),
...
$(document).ready(function() {
	...
	$("#message-form").submit(function (e) {
		e.preventDefault();
		var $el = $(this),
		randomAnswer = new Array("3 Listing sudah Expired", "2 Listing dengan status Unverified", "Reminder untuk mengupdate hot pick list.");
...
if($("#flot-hdd").length > 0){
	var data = [[1, 5],[2, 4],[3, 7],[4, 9],[5, 15],[6, 9],[7, 10]];
...
if($("#flot-newlisting").length > 0){
	var data = [[1, 15],[2, 24],[3, 17],[4, 19],[5, 5],[6, 9],[7, 10]];

	$.plot($("#flot-newlisting"), [{ 
		label: "New Listing By Period", 
		data: data,
		color: "#2c5e7b"
	}], {
